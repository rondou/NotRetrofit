...
public abstract class GitHub2 {
    ...
    public static GitHub2 create() {
        return new Retrofit_GitHub2();
    }

    // promise parameter
    public static GitHub2 create(Activity activity) {
    ...
    public abstract static class Builder {
        ...
        public abstract GitHub2 build();
    }

    public static Builder builder() {
        return new Retrofit_GitHub2.Builder();
    }
}
